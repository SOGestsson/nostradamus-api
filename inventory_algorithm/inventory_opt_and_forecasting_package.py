...
try:
    from . import get_and_post_data as read_data
except ImportError:
...
try:
    from . import simulator_class  as sim
except ImportError:
...
class get_raw_data():
    ...
    def create_rio_item_details_test_data(self, pn):
        rio_item_details = self.rio_item_details[self.rio_item_details.id.isin([pn])]
        return rio_item_details
